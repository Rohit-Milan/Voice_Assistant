     ...
     while(confirm!=True):
      ...
      if confirmation=='yes':
        ...
        if s:    # frame captured without any errors
            ...
            storagen=storage.replace('V.1.0.py', '')
   ...
   while True:
        ...
        if 'wikipedia' in query:  #searches wikipedia
            ...
            if s:    # frame captured without any errors
                ...
                ec.imwrite(os.path.abspath(getsourcefile(lambda:0)).replace(os.path.basename(getsourcefile(lambda:0)),"filename.jpg"),img)#save image
